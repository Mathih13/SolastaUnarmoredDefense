...
namespace SolastaUnarmoredDefense
{
    public class Main
    {
        ...
        internal static void ModEntryPoint()
        {
            ...
            //
            skeleton.GuiPresentation.Title = "SolastaUnarmoredDefense/&FancySkeletonTitle";
            skeleton.GuiPresentation.Description = "SolastaUnarmoredDefense/&FancySkeletonDescription";
        }
    }
}
